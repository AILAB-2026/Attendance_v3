...
- When testing on a physical device on the same LAN, set both `API_BASE_URL` and `EXPO_PUBLIC_API_BASE_URL` to your machine's LAN IP (e.g., `http://192.168.1.5:3000`).

                        ...
                        <View style={styles.sectionCard}>
                            {section.questions?.map((q: any, qIndex: number) => {
                                ...
                                if ((type === 'gps_location' || type === 'gps_location_manual') && answer) {
                                    ...
                                    const gpsMode = titleLower.includes('latitude')
                                        ? 'latitude'
                                        : titleLower.includes('longitude')
                                            ? 'longitude'
                                    ...
                                    return (
                                        <View key={q.id} style={[styles.questionRow, !isLast && styles.questionRowBorder]}>
                                            ...
                                            <View style={styles.questionInputColumn}>
                                                {gpsMode === 'latitude' && (
                                                    <Text style={{ color: '#334155', fontSize: 14, fontWeight: '500' }}>{parsed.latitude || '-'}</Text>
                                                )}
                                                {gpsMode === 'longitude' && (
                                                    <Text style={{ color: '#334155', fontSize: 14, fontWeight: '500' }}>{parsed.longitude || '-'}</Text>
                                                )}
                                                {gpsMode === 'location' && (
                                                    <Text style={{ color: '#334155', fontSize: 14, fontWeight: '500' }}>{parsed.address || '-'}</Text>
                                                )}
                                                {gpsMode === 'all' && (
                                                    <>
